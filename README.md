...
[![Play on itch.io](https://img.shields.io/badge/Play%20on-itch.io-fa5c5c?logo=itch.io&logoColor=white)](https://lipepipo.itch.io/wheelchairsimulator)
[![Watch on YouTube](https://img.shields.io/badge/Watch-YouTube-ff0000?logo=youtube&logoColor=white)](https://www.youtube.com/watch?v=VZxXgHsz650&t=86s)
...
You can download the simulator from the **[itch.io page](https://lipepipo.itch.io/wheelchairsimulator)**.
...
1. Go to the [itch.io page](https://lipepipo.itch.io/wheelchairsimulator) and download the **VR version** (`.apk` file).
...
4. On the headset, open the app from the library (under **Unknown Sources** / **Apps**).
...
- 📺 **Demo video:** [YouTube](https://www.youtube.com/watch?v=VZxXgHsz650&t=86s)
